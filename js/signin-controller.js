...
BookIt.SignInController.prototype.init = function () {
    ...
    this.documentsPage = "customer-documents.html";
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            if (resp.success === true) {
                ...
                var userId = resp.extras.userProfileModel.id;
                var userType = resp.extras.userProfileModel.type;
                // Go to main menu.
                if(userType=='school')
                	$.mobile.navigate(me.mainMenuPageId);
                else                	
                	$.mobile.changePage(me.documentsPage, { dataUrl : me.documentsPage+'?customer='+userId, data : { 'customer' : userId }, reloadPage : true, changeHash : true});
                return;
            } else {
                if (resp.extras.msg) {
